"""DAG for running dbt bronze layer with logging and alerting"""
...
dag = DAG(
    ...
    description="Run dbt bronze layer models with logging and alerting",
    schedule_interval=timedelta(minutes=30),
    start_date=datetime(2024, 1, 1),
    catchup=False,
    tags=["dbt", "bronze", "sqlserver", "monitoring"],
)
